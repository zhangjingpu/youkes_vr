...
public class SimpleVrPanoramaActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.panno_layout);
    ...
    panoWidgetView.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
      @Override
      public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        Toast.makeText(SimpleVrPanoramaActivity.this,menuInfo.toString(),Toast.LENGTH_LONG);
      }
    });
  ...
  class ImageLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
    ...
    protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
      ...
      panoOptions = new Options();
      panoOptions.inputType = Options.TYPE_STEREO_OVER_UNDER;
      Bitmap loadBitmap=loadBitmapStream();

      panoWidgetView.loadImageFromBitmap(loadBitmap, panoOptions);
  ...
  public Bitmap loadBitmapStream(){
    String icoURI = "http://youkes.oss-cn-hangzhou.aliyuncs.com/vr%2Fandes.jpg";
    try {
      URL imgURL = new URL(icoURI);

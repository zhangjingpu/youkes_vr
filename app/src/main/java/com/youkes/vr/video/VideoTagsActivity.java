...
public class VideoTagsActivity extends AppViewPagerActivity {
	...
	public String getTitleString() {
		return getIntent().getStringExtra("tag")+getString(R.string.video);
	}
	...
	protected ArrayList<ChannelItem> getUserChannelLists(){
		return VideoTypeNames.defaultTagChannels;
	}

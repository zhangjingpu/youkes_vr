...
public class MediaPlayTools2 {

	private static final String TAG = "MediaPlayTools";
	private static MediaPlayTools2 mInstance = null;
	...
	public MediaPlayTools2() {
		setOnCompletionListener();
		setOnErrorListener();
	}

	synchronized public static MediaPlayTools2 getInstance() {
		if (null == mInstance) {
			mInstance = new MediaPlayTools2();
		}
		return mInstance;

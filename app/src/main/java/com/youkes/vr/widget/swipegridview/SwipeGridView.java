 ...
 */
public class SwipeGridView extends GridView implements OnScrollListener {
     ...
     */
    private SwipeGridViewTouchListener touchListener;
    ...
    private void init(AttributeSet attrs) {
        ...
        touchListener = new SwipeGridViewTouchListener(this, swipeFrontView, swipeBackView);
    ...
    private void removeFooterView(RelativeLayout footerLayout) {
    }

    private void addFooterView(RelativeLayout footerLayout) {

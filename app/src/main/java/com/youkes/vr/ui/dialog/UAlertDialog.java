...
public class UAlertDialog extends Dialog implements View.OnClickListener {

    public static final String TAG = "com.youkes.weshare.AlertDialog";
    /**左边按钮*/
    ...
    public static UAlertDialog buildAlert(Context ctx, int message,int button , OnClickListener listener) {
        return buildAlert(ctx, ctx.getString(message) , ctx.getString(button), listener);
    }

    public static UAlertDialog buildAlert(Context ctx, String message,int button , OnClickListener listener) {
        return buildAlert(ctx,message , ctx.getString(button), listener);
    }
    
    public static UAlertDialog buildAlert(Context ctx, int resId, OnClickListener listener) {
        return buildAlert(ctx, resId, R.string.dialog_btn_cancel, R.string.dialog_btn_confim, null, listener);
    }

    public static UAlertDialog buildAlert(Context ctx, int resId,
    ...
    public static UAlertDialog buildAlert(Context ctx, CharSequence message,
    ...
    public static UAlertDialog buildAlert(Context ctx, int message,
    ...
    public static UAlertDialog buildAlert(Context ctx, CharSequence message,
                                           ...
                                           OnClickListener negativeClickListener,
                                           OnClickListener positive) {
        UAlertDialog dialog = new UAlertDialog(ctx);
     ...
     * @return
     */
    public static UAlertDialog buildAlert(Context ctx, CharSequence message,CharSequence text,
                                           OnClickListener positive) {
        UAlertDialog dialog = new UAlertDialog(ctx);
        dialog.setMessage(message);
    ...
    public static UAlertDialog buildPositiveAlert(Context ctx , int resId , OnClickListener listener) {
     ...
     * @return
     */
    public static UAlertDialog buildPositiveAlert(Context ctx , CharSequence message , OnClickListener listener) {
        UAlertDialog dialog = new UAlertDialog(ctx);
        dialog.setMessage(message);
    ...
    public final UAlertDialog setButtonTag(int id , OnClickListener listener) {
        Button button = mButtons.get(id);

...
import com.youkes.vr.ui.emoji.EmojiconTextView;
import com.youkes.vr.utils.DensityUtil;
import com.youkes.vr.utils.GlideUtil;
import com.youkes.vr.utils.URLUtil;
...
public class TopBarView extends LinearLayout {
        ...
        if(searchBox !=null){
            if(!b) {
                ...
                searchBox.setVisibility(View.VISIBLE);
                 ...
                 text_mid_layout.setVisibility(View.GONE);
	...
	private void initView() {
        ...
        text_mid_layout = (LinearLayout) findViewById(R.id.text_mid_layout);
        top_right = findViewById(R.id.top_right);
	}

    View top_right=null;
    LinearLayout text_mid_layout=null;

...
public class SimpleVrVideoActivity extends Activity {
  ...
  private void handleIntent(Intent intent) {
    ...
    if (Intent.ACTION_VIEW.equals(intent.getAction())) {
      ...
      //Uri.parse("");
      fileUri= Uri.parse("http://youkesvideo.oss-cn-hangzhou.aliyuncs.com/movie/%5B%E7%85%8E%E9%A5%BC%E4%BE%A0%5D%E4%B8%AD.Jian.Bing.Man.2015.HD720P.X264.AAC.Mandarin.CHS-ENG.Mp4Ba.mp4");
